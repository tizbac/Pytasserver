...
if cl.battle == -1:
  if len(args) >= 10:
	...
	self.main.cid = 0
      ...
      self.main.battles.update([(cl.battle,Battle(args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8],args2[0],args2[1],args2[2],cl.username,cl.ip[0],cl.battle,cl.lanip))])
      self.main.broadcastEX(self.main.battles[cl.battle].forgebattleopened)
      c.send("OPENBATTLE %i\n" % cl.battle)
